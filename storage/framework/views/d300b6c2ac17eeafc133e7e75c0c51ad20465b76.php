...
<body>
  ...
  <a class="cl_logo hidden-lg hidden-md " href="/"
                title="Bkacad">
      <h4 class="title-head" style="color:#006182;size:50px;"> BKACAD LIBRARY</h4>
  </a>
    ...
    <div class="collapse navbar-collapse" id="bdNavbar" >
      <ul class="navbar-nav flex-row flex-wrap bd-navbar-nav pt-2 py-md-0">
        <li class="nav-item col-1 col-md-auto">
          <a class="nav-link p-1" href="<?php echo e(url('/book')); ?>" >Quản lí sách</a>
        </li>
        <li class="nav-item col-2 col-md-auto">
          <a class="nav-link p-1" href="#" >Quản lí độc giả</a>
          
        </li>
        <li class="nav-item col-3 col-md-auto">
          <a class="nav-link p-1" href="#" >Quản lí sách đã mượn</a>
        </li>
      </ul>
...
</html><?php /**PATH C:\xampp\htdocs\Laravel\project2\resources\views/layout.blade.php ENDPATH**/ ?>