...
<div class="col-xs-4 col-xs-offset-4">
	...
	<?php echo csrf_field(); ?>
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" id="name" name="name" value="<?php echo e($book->name); ?>" maxlength="255" required />
		</div>
		<div class="form-group">
			<label for="details">Mô tả</label>
			<input type="text" class="form-control" id="details"  name="details" value="<?php echo e($book->details); ?>" maxlength="255" required />
		</div>
		<div class="form-group">
			<label for="details">Avatar</label>
			<input type="file" class="form-control-file" id="ava"  name="ava" />
		</div>
		<input type="hidden" name="oldAva" value="<?php echo e($book->avatar); ?>">
		<div class="form-group">
			...
			<select name="author" id="author" class="form-control">
				...
				<?php $__currentLoopData = $author; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aut): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<option <?php echo e(($aut->id) == ($book->author->id)? "selected" : ""); ?> value="<?php echo e($aut->id); ?>"><?php echo e($aut->name); ?></option>
		...
		<div class="form-group">
			...
			<select name="nxb" id="nxb" class="form-control">
				...
				<?php $__currentLoopData = $nxb; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nx): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<option <?php echo e(($nx->id) == ($book->nxb->id)? "selected" : ""); ?> value="<?php echo e($nx->id); ?>"><?php echo e($nx->name); ?></option>
				<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
			</select>
		...
		<div class="form-group">
			...
			<select name="type" id="type" class="form-control">
				...
				<?php $__currentLoopData = $type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $typ): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<option <?php echo e(($typ->id) == ($book->type->id)? "selected" : ""); ?> value="<?php echo e($typ->id); ?>"><?php echo e($typ->name); ?></option>
				<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
			</select>
...
<?php echo $__env->make('templates.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel\project2\resources\views/book/edit.blade.php ENDPATH**/ ?>